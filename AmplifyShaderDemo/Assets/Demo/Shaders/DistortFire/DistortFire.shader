...
Shader "DistortFire"
{
	Properties
	{
		...
		_NoiseScale("NoiseScale", Range( 0 , 10)) = 3.91638
		_NoiseScale2("NoiseScale2", Range( 0 , 10)) = 1.877107
		_NoiseSpeed2("NoiseSpeed2", Range( 0 , 5)) = 1.54
		_NoiseTex("NoiseTex", 2D) = "white" {}
		_Noise3Speed("Noise3Speed", Range( 0 , 5)) = 0.7
		[ASEEnd]_DistortStrength("DistortStrength", Float) = 10
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_17_0 = ( _TimeParameters.x * -0.1 );
				float time11 = temp_output_17_0;
				float2 voronoiSmoothId11 = 0;
				float2 texCoord13 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float4 appendResult18 = (float4(0.0 , ( 1.23 * temp_output_17_0 ) , 0.0 , 0.0));
				float2 coords11 = ( float4( texCoord13, 0.0 , 0.0 ) + appendResult18 ).xy * _NoiseScale;
				float2 id11 = 0;
				float2 uv11 = 0;
				float voroi11 = voronoi11( coords11, time11, id11, uv11, 0, voronoiSmoothId11 );
				float time34 = temp_output_17_0;
				float2 voronoiSmoothId34 = 0;
				float2 texCoord31 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float4 appendResult28 = (float4(0.0 , ( temp_output_17_0 * _NoiseSpeed2 ) , 0.0 , 0.0));
				float2 coords34 = ( float4( texCoord31, 0.0 , 0.0 ) + appendResult28 ).xy * _NoiseScale2;
				float2 id34 = 0;
				float2 uv34 = 0;
				...
				float4 appendResult40 = (float4(0.0 , ( temp_output_17_0 * _Noise3Speed ) , 0.0 , 0.0));
				float4 appendResult43 = (float4(0.0 , ( ( ( voroi11 * voroi34 ) * tex2D( _NoiseTex, ( float4( uv_NoiseTex, 0.0 , 0.0 ) + appendResult40 ).xy ).r ) * _DistortStrength ) , 0.0 , 0.0));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = tex2D( _MainTex, ( float4( uv_MainTex, 0.0 , 0.0 ) + appendResult43 ).xy ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
304;132.6667;1336;793;3037.275;268.1002;4.00618;True;True
Node;AmplifyShaderEditor.CommentaryNode;46;-1484.853,1432.287;Inherit;False;1156.444;389.811;Noise3;6;38;39;40;41;35;36;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;33;-1750.355,669.4172;Inherit;False;1459.85;676.3945;Noise2;7;26;31;30;29;28;27;34;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;32;-1721.178,61.858;Inherit;False;1236.403;558.7583;Noise1;10;11;16;17;25;14;24;18;19;13;12;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-1605.425,278.2973;Inherit;False;Constant;_NoiseSpeed;NoiseSpeed;2;0;Create;True;0;0;0;False;0;False;1.23;0;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;35;-649.0743,1565.781;Inherit;True;Property;_NoiseTex;NoiseTex;5;0;Create;True;0;0;0;False;0;False;-1;e24b2c680edaa90458d31f11544d79ca;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;30;-1100.522,1061.172;Inherit;False;Property;_NoiseScale2;NoiseScale2;2;0;Create;True;0;0;0;False;0;False;1.877107;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;16;-1641.391,385.1885;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-1700.355,959.4067;Inherit;False;Property;_NoiseSpeed2;NoiseSpeed2;4;0;Create;True;0;0;0;False;0;False;1.54;1;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;343.4386,1035.118;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;34;-734.0861,848.4012;Inherit;True;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.VoronoiNode;11;-686.7752,195.3151;Inherit;True;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.RangedFloatNode;38;-1434.853,1644.341;Inherit;False;Property;_Noise3Speed;Noise3Speed;6;0;Create;True;0;0;0;False;0;False;0.7;0;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;39;-1166.075,1610.202;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;40;-987.9539,1643.098;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleAddOpNode;41;-809.1388,1590.134;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.DynamicAppendNode;28;-1137.137,847.0264;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.DynamicAppendNode;18;-1108.793,305.3884;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;106.8864,822.791;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-1008.982,433.4937;Inherit;False;Property;_NoiseScale;NoiseScale;1;0;Create;True;0;0;0;False;0;False;3.91638;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;-138.0062,538.1912;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;10;888.0805,795.3635;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;6f3939a5684ebf046b4d9a9f4395b272;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;31;-1232.672,719.4172;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;-1327.212,874.9526;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-1671.178,505.6163;Inherit;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;0;False;0;False;-0.1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;19;-924.7407,205.9727;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;13;-1200.463,111.858;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;36;-1091.661,1482.287;Inherit;False;0;35;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-1470.391,431.1885;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-1312.777,329.6162;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;20;393.0684,657.6251;Inherit;False;0;10;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;23;724.8297,825.387;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;44;93.21243,1114.67;Inherit;False;Property;_DistortStrength;DistortStrength;7;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;43;535.4756,1011.616;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleAddOpNode;29;-967.0707,866.1487;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=12D169421CD760EE080AFFA5B2825318B387CCA0