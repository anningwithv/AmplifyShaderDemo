...
Shader "UVDistortShader"
{
	Properties
	{
		...
		_Strength("Strength", Range( 0 , 1)) = 0.03784183
		_SpeedX("SpeedX", Range( 0 , 5)) = 0.1
		[ASEEnd]_SpeedY("SpeedY", Range( 0 , 5)) = 0.1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 appendResult20 = (float4(_SpeedX , _SpeedY , 0.0 , 0.0));
				float2 texCoord21 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner17 = ( 1.0 * _Time.y * appendResult20.xy + texCoord21);
				float2 temp_cast_1 = (tex2D( _NoiseTex, panner17 ).r).xx;
				float2 lerpResult14 = lerp( texCoord16 , temp_cast_1 , _Strength);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = tex2D( _MainTex, lerpResult14 ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
-46;294.6667;1336;799;2999.538;516.4539;2.437476;True;True
Node;AmplifyShaderEditor.SamplerNode;12;-445.4144,-4.275635;Inherit;True;Property;_MainTex;MainTex;1;0;Create;True;0;0;0;False;0;False;-1;1b7df2be1d6aac14ebdf01262c384efb;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;19;-2006.831,304.668;Inherit;True;Property;_SpeedY;SpeedY;4;0;Create;True;0;0;0;False;0;False;0.1;0;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;14;-690.1644,93.82467;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-1997.185,81.06226;Inherit;True;Property;_SpeedX;SpeedX;3;0;Create;True;0;0;0;False;0;False;0.1;0;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-962.1644,320.8247;Inherit;False;Property;_Strength;Strength;2;0;Create;True;0;0;0;False;0;False;0.03784183;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;21;-1594.216,-111.2399;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;16;-1012.127,-149.2619;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;17;-1352.525,118.8092;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;20;-1594.406,139.7896;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SamplerNode;11;-1081.814,115.98;Inherit;True;Property;_NoiseTex;NoiseTex;0;0;Create;True;0;0;0;False;0;False;-1;e24b2c680edaa90458d31f11544d79ca;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=E0E002FDF26DE0BAC594512726F450BD27D2B2C2